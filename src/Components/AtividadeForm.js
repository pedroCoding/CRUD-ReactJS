            ...
            <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-md-6">
                    ...
                    <select id="prioridade" name='prioridade' value={atividade.prioridade} onChange={inputTextHandler} className="form-select">
                        <option dafaultValue="0">Selecionar...</option>
                ...
                <div className="col-md-12">
                    ...
                    <textarea name="descricao" value={atividade.descricao} id="descricao" onChange={inputTextHandler} type="text" className="form-control" />
                <hr />
                </div>
